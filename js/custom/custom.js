/*
Template: geevida health and support
Author: ScriptsBundle
Version: 1.0
Designed and Development by: Mukesh
*/
/*
====================================
[ CSS TABLE CONTENT ]
...
(function($) {
   ...
   /* ======= Progress bars ======= */
    ...
    $("#ghs_register_btn").on('click', function(){

        window.location="register.php";
    });
   
    $("#ghs_log_btn").on('click', function(){
    ...
    /***********Get States Lists************/
    $.ajax({
        url         : baseAPIUrl+'statesListAPi',
        type        : "GET",
        contentType : 'application/json',
        success:function(data){

            var html='<option value="">States</option>';
